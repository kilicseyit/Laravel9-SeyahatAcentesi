    ...
    <div class="row">
        ...
        <div class="main">
            ...
            <div class="product-preview__title">
                <h1 class="h1 alt-h1 "> Frequently Asked Questions</h1>
            </div>
    ...
    <div class="end-content container">
        <div class="container">
            <section class="text-center my-5 p-1">
                ...
                <h4 class="dark-grey-text w-responsive mx-auto mb-5"><i>Tell us where you heard about us in the forum
                        section</i></h4>
                <div class="row">
                    <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
                        <div class="card testimonial-card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="dark-grey-text mt-4"><i class="fas fa-quote-left pr-2"></i>Lorem ipsum dolor
                                    sit amet eos
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card testimonial-card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="dark-grey-text mt-4"><i class="fas fa-quote-left pr-2"></i>Delectus impedit
                                    saepe officiis
