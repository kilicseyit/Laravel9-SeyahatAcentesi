                            ...
                            <div class="col-lg-10 offset-lg-1">
                                <div class="cart_container">
                                        ...
                                        <ul class="cart_list">
                                            ...
                                            <li class="cart_item clearfix">
                                                    ...
                                                    <div
                                                        ...
                                                        <td>
                                                            <a href="{{route('shopcart.destroy',['id'=> $rs -> id])}}"class="btn btn-danger btn-icon-text" onclick="return confirm('Deleting !! Are you sure ?')"><i class="fa fa-close"></i></a>
                                                        </td>
                                                    </div>
                                    ...
                                    <div class="cart_buttons">
                                        <button type="button" class="button cart_button_clear">Continue Shopping
                                        </button>
